...
const SECTION_TITLE_STYLE = {order: 2 as TitleOrder, c:"black", fw:200, fz:'2.5rem', ta:'center', mb:'xl'} as TitleProps
    ...
    <>
      <Box className={classes.hero}>
        <Stack align="center" gap="lg" className={classes.heroContent}>
          <Title c="black" fz="2rem" lts={28} fw={100} order={1} >
            GIULIA & FLORIAN
          </Title>
          <Text size="xl" fw={300} lts={8} fs='italic' c='black'>
            Se marient
          </Text>
        </Stack>
      </Box>
      ...
      <Box bg='pink.1' mih={300}>
        <Container size="md" py="xl">
          <Stack align="center" gap="xl">
            ...
            <Text size="lg" c="black" fw={200} fs='italic' ta='center' lh={1.8}>
        ...
        <Container size="lg" py="xl">
          <Grid>
            <Grid.Col span={{ base: 12, md: 4 }}>
              <Title {...SECTION_TITLE_STYLE} ta='left'>
                INFOS
                <br />
                PRATIQUES
              </Title>
